...
public class Board extends JPanel implements ActionListener{
    ...
    private void loadImages() {
        ...
        Image apbuffer = iia.getImage();
        Image newapBuffer = apbuffer.getScaledInstance(10, 10, java.awt.Image.SCALE_SMOOTH);
        iia = new ImageIcon(newapBuffer);
        apple = iia.getImage();

        ImageIcon iih = new ImageIcon("Head.png");
        Image headbuffer = iih.getImage();
        Image newheadBuffer = headbuffer.getScaledInstance(10, 10, 4);
        iih = new ImageIcon(newheadBuffer);
        head = iih.getImage();
    }
